      ...
      <Card className="bg-moncees-black border-moncees-gold border-2 shadow-lg overflow-hidden fade-in delay-100">
        <CardContent className="pt-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-cormorant font-semibold text-moncees-gold mb-1 text-xl">Phone</h3>
              <p className="text-moncees-white font-nunito">+1 (555) 123-4567</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-moncees-black border-moncees-gold border-2 shadow-lg overflow-hidden fade-in delay-200">
        <CardContent className="pt-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-cormorant font-semibold text-moncees-gold mb-1 text-xl">Email</h3>
              <p className="text-moncees-white font-nunito">info@monceesrestaurant.com</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-moncees-black border-moncees-gold border-2 shadow-lg overflow-hidden fade-in delay-300">
        <CardContent className="pt-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-cormorant font-semibold text-moncees-gold mb-1 text-xl">Location</h3>
              <p className="text-moncees-white font-nunito">123 Luxury Ave, Beverly Hills, CA 90210</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-moncees-black border-moncees-gold border-2 shadow-lg overflow-hidden fade-in delay-400">
        <CardContent className="pt-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-cormorant font-semibold text-moncees-gold mb-1 text-xl">Hours</h3>
              <div className="text-moncees-white font-nunito space-y-1">
